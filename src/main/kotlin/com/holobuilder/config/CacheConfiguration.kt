...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.holobuilder.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.holobuilder.repository.UserRepository.USERS_BY_EMAIL_CACHE)
