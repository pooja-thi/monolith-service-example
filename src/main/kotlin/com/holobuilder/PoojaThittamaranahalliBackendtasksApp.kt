...
import com.holobuilder.config.ApplicationProperties
...
class PoojaThittamaranahalliBackendtasksApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes pooja_thittamaranahalli_backendtasks.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<PoojaThittamaranahalliBackendtasksApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(PoojaThittamaranahalliBackendtasksApp::class.java)
