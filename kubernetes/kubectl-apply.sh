...
logSummary() {
    echo ""
        ...
        echo "pooja_thittamaranahalli_backendtasks - http://pooja_thittamaranahalli_backendtasks.default.192.168.99.100.nip.io"
        echo "#####################################################"
}

default() {
    suffix=k8s
    kubectl apply -f pooja_thittamaranahalli_backendtasks-${suffix}/
